...
<div class="cloudcast_header">
    ...
    <div class="cloudcast_header-right">
        <button type="submit" class="btn btn-primary" form="streams_form">SAVE</button>
...
<!-- stream form -->
<?php echo Form::open(array('id' => 'streams_form', 'action' => $action, 'class' => 'form-horizontal', 'data-bind' => 'with: stream')); ?>
