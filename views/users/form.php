...
<div class="cloudcast_header">
    ...
    <div class="cloudcast_header-right">
        <button type="submit" class="btn btn-primary" form="user_form">SAVE</button>
...
<!-- user form -->
<?php echo Form::open(array('id' => 'user_form', 'action' => $action, 'class' => 'form-horizontal', 'data-bind' => 'with: user')); ?>
